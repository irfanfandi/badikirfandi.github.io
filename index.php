			...
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<div class="progress-wrap ftco-animate">
						<h3>NodeJS</h3>
						<div class="progress" style="background:#ffffff;">
							<div class="progress-bar color-6" role="progressbar" aria-valuenow="70" aria-valuemin="0"
				...
				<div id="recipeCarousel" class="carousel slide w-100" data-ride="carousel">
					<div class="carousel-inner w-100" role="listbox">
						...
						<div class="carousel-item">
							<div class="col-md-4">
								<div class="card card-body">
									...
									<a style="color: black;">Pembuatan Website Desain Stempel yang memudahkan pelanggan untuk membuat desain stempel sendiri dan melakukan pembelian.</a>
								</div>
							</div>
						</div>
						<div class="carousel-item">
						...
						<div class="carousel-item">
							<div class="col-md-4">
								<div class="card card-body">
									<img class="img-fluid" src="https://irfanfandi.github.io/images/project-4.jpg"><br>
									<h6 style="color: black;">Web Application</h6>
									<a style="color: black;">Web Application Restaurant membantu dalam pemesanan
										pelanggan dan informasi menu dan harga makanan.</a>
								</div>
							</div>
						</div>
						<div class="carousel-item">
			...
			<div class="row d-flex contact-info mb-5">
				<div class="col-md-6 col-lg-4 col-sm-3 d-flex ftco-animate">
					<div class="align-self-stretch box p-4 text-center">
						...
						<p>Kletek RT 17 RW 07, Taman-Sidoarjo</p>
					</div>
				</div>
				<div class="col-md-6 col-lg-4 col-sm-3 d-flex ftco-animate">
					<div class="align-self-stretch box p-4 text-center">
						...
						<p><a href="https://irfanfandi.github.io/tel://1234567920">+62-88228455435</a></p>
					</div>
				</div>
				<div class="col-md-6 col-lg-4 col-sm-3 d-flex ftco-animate">
					<div class="align-self-stretch box p-4 text-center">
						...
						<p><a href="https://irfanfandi.github.io/mailto:info@yoursite.com">irfanfandi38@gmail.com</a>
						</p>
					</div>
				</div>
			</div>
